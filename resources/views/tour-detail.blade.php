                            ...
                            <div class="ajax-holder">
                                ...
                                <div id="overview-tab" role="tabpanel" style="display: block"
                                    ...
                                    <div class="tour__content__block tour__content__block--quotereq hide show-t">
                                        ...
                                        <p>
                                            <a href="{{url('bid-on-tour')}}/operator/{{$userId}}/tour/{{$tour->id}}"
                                               rel="nofollow"
                                               class="btn btn--autowidth btn--autowidth--wide btn--orange btn--reqquote btn--withsubtext"
                                               style="background: black;border: black">Bid on Tour<br/><span>for a custom or selected tour</span></a>
                                        </p>
                                        ...
                                        <ul class="list list--icon list--icon-arrow list--icon-nopadding txt--small txt--grey">
                                            ...
                                            <li>We advise <b>requesting quotes</b> from <b>3 operators</b>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col col-12  col-d-8   operator-data no-gutter-left">
                                                ...
                                                <h1 itemprop="name" class="serif with-save-btn">
                                                    ...
                                                    <span class="favorite-save hide show-ti  " data-id="3424"
                                                          data-type="operator"
                    ...
                    <a href="#" onclick="openTab('reviews')" class="reviews-link"
                       rel="nofollow">{{$reviews}} Reviews</a>
                                        ...
                                        <div class="row opreviews_div">
                                            ...
                                            <div class="col col-12 col-d-9 reviewlist__list">
                                                @foreach($reviewsDeceding as $review)
                                                    <div class="review initialized" id="58806" itemprop="reviews"
                                                         itemscope="" itemtype="http://schema.org/Review">
                                                        <div class="review__person" itemtype="http://schema.org/Person"
                                                             itemscope="" itemprop="author">
                                                            <i class="sbi sbi--avatar-female"></i>
                                                            <strong class="review__person__name"
                                                                    itemprop="name">{{$review->name}}</strong>
                            ...
                            {{$review->country}}
                                                            ...
                                                            <span itemprop="gender" itemscope=""
                                                                  itemtype="http://schema.org/GenderType">
                <span itemprop="name" content="Female"></span>
                                                        ...
                                                        <div class="review__body">
                                                            ...
                                                            <div class="overallrating">
                                                                <div class="stars    large    " itemprop="reviewRating"
                                                            ...
                                                            <div class="review__body__photos galleryitems"
                                                                 data-overlay-hash="p58806">
                                                                @foreach($review->images as $image)
                                                                    <a itemprop="associatedMedia" itemscope=""
                                                                       itemtype="http://schema.org/MediaObject"
                                                                       target="_blank"
                                                                       href="{{url('view-review-image')}}/{{$image->id}}"
                                                                       title="" rel="overlay" class="galleryitem">
                                                                        <img
                                                                            src="{{url('view-review-image')}}/{{$image->id}}">
                                                                    </a>
                                                                @endforeach
                                                            </div>
                                                        </div>
                    ...
                    <div class="col hide show-d col-d-4 tour__sidebar" role="complementary" itemprop="offers" itemscope
                        ...
                        <div class="sidebar__block conversionblock hide show-d" itemprop="priceSpecification" itemscope
                            ...
                            <div class="conversionblock__cta">
                                <a href="{{url('bid-on-tour')}}/operator/{{$userId}}/tour/{{$tour->id}}" rel="nofollow"
                                   class="btn btn--orange btn--reqquote btn--withsubtext"
                                   style="background: black;border: black">Bid on Tour<br/><span>for a custom or selected tour</span></a>
                                {{--                                <a href="../request-quote/t17948.html" rel="nofollow"--}}
                            ...
                            <p class="conversionblock__usp" style="margin-top:25px">
                                ...
                                <span class="conversionblock__usp-text">Best price guarantee</span>
                            </p>
